...
new_tree = ArrayTreeToTreeClass(simulation.Tree, simulation.times)
new_tree.show()

le = LikelyhoodEstimation(new_tree, GetEventsFromTree(new_tree))
estimation = LikelyhoodEstimation.GetEstimation(le, new_tree, GetEventsFromTree(new_tree))
